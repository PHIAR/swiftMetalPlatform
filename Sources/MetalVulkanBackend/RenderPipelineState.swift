...
internal final class VkMetalRenderPipelineState: RenderPipelineState,
    ...
    internal func getGraphicsPipeline(topology: VulkanPrimitiveTopology,
        ...
        let frontStencilState = VulkanStencilOpState(failOp: .keep,
                                                     passOp: .keep,
                                                     depthFailOp: .keep,
                                                     compareOp: .less,
                                                     compareMask: 0,
                                                     writeMask: 0,
                                                     reference: 0)
        let backStencilState = VulkanStencilOpState(failOp: .keep,
                                                    passOp: .keep,
                                                    depthFailOp: .keep,
                                                    compareOp: .less,
                                                    compareMask: 0,
                                                    writeMask: 0,
                                                    reference: 0)
        let depthStencilState = VulkanPipelineDepthStencilState(depthTestEnable: false,
